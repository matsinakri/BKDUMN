...
<head>
    ...
    <title><?php if ( $pg == 'kb_penelitian' ) { ?>Kinerja Bidang Penelitian<?php } ?></title>
    <!-- Favicon-->
    <link rel="icon" href="bootstrap/poltek.ico" type="image/x-icon">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Beban Kerja Dosen UM Natsir</a>
        </div>
                    ...
                    <div class="btn-group m-t-20 m-r-25" style="box-shadow: none;">
                        <a href="#" style="text-decoration: none;color: #ffffff;display: flex;flex-direction: row;"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            <div class="h5 p-b-5"> <?php echo $_SESSION['nama_user'] ?>&nbsp;</div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="legal">
            <div class="copyright">
                &copy;Copyright <a href="javascript:void(0);">UM Natsir Bukittinggi</a> <br> 
                Develop by  
                <a href="https://inakri.com" target="_blank">Inakri Creative</a>
            </div>
            <div class="version">
                <b>Version: </b> 1.0
            </div>
